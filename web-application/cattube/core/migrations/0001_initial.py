    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw', models.FileField(storage=cattube.storage_backends.PrivateMediaStorage(), upload_to='')),
                ('transcoded', models.FileField(storage=cattube.storage_backends.PrivateMediaStorage(), blank=True,
                                                default=None, null=True, upload_to='')),
                ('thumbnail', models.FileField(storage=cattube.storage_backends.PrivateMediaStorage(), blank=True,
                                               default=None, null=True, upload_to='')),
